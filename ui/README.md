...
For local simulation, keep the default `http://localhost:8000` and start the firmware in mock mode. The UI will show connection status plus the frequency measured by the firmware, along with firmware-reported timestamps.
